...
def main():
    ...
    from src.security.encryption import (
        EncryptionService, KeyManager, AESEncryptor, FileEncryptor,
        EncryptionConfig, EncryptedData, EncryptionAlgorithm,
        KeyDerivationFunction, DecryptionError, EncryptionError
    )
    ...
    from src.security.audit import (
        ...
        PHIMasker, AuditContext, audit_log
    )
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert ctx.get('request_id') == 'req-001' or (hasattr(ctx, 'request_id') and ctx.request_id == 'req-001')
    ...
    from src.security.data_cleanup import (
        SecureDataCleanup, SecureOverwriter, TempFileManager,
        RetentionManager, RetentionPolicy, DeletionMethod,
        MemorySecurityManager, CleanupStats
    )
    ...
    from src.security.rbac import (
        RBACManager, TokenManager, PasswordManager, UserStore,
        User, Role, Permission, TokenPayload, TokenPair,
    ...
    from src.monitoring.metrics import (
        ...
        MetricNamespace, MetricLabels,
        track_duration, count_calls
    )
    ...
    from src.monitoring.alerts import (
        ...
        AlertChannel, NotificationConfig, LogHandler,
    ...
    from src.api.middleware import (
        SecurityHeadersMiddleware, MetricsMiddleware, AuditMiddleware,
        AuthenticationMiddleware, RateLimitMiddleware, RateLimiter,
